(function(win, dom) {
    ...
    MyScrollBar.prototype.initEvent = function() {
        ...
        if (this.bYBar) {
            ...
            this.oYBar.onmousedown = function(e) {
                if (_this.bYShow) {
                    bYDown = true;
                    iDownPageY = e.clientY/_this.rebuildRatio[1] + dom.documentElement.scrollTop || dom.body.scrollTop;
            ...
            dom.addEventListener('mousemove', function(e) {
                if (bYDown && _this.bYShow) {
                    var iNowPageY = e.clientY/_this.rebuildRatio[1] + dom.documentElement.scrollTop || dom.body.scrollTop;
        ...
        if (this.bXBar) {
            ...
            this.oXBar.onmousedown = function(e) {
                if (_this.bXShow) {
                    bXDown = true;
                    iDownPageX = e.clientX/_this.rebuildRatio[0] + dom.documentElement.scrollLeft || dom.body.scrollLeft;
            ...
            dom.addEventListener('mousemove', function(e) {
                if (bXDown && _this.bXShow) {
                    var iNowPageX = e.clientX/_this.rebuildRatio[0] + dom.documentElement.scrollLeft || dom.body.scrollLeft;
    ...
    MyScrollBar.prototype.setParam = function(o) {
        ...
        this.rebuildRatio = o.rebuildRatio?o.rebuildRatio:[1,1];
    }
