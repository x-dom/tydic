...
var allCity = {
    "0": [116.41863928076, 40.18693241013],
...
var HTTP_PROTOCOL_Name='https://';
// var HOST_PATH = '135.224.181.135:6001/tydic-xj-integration-backend/';
// var HOST_PATH = '222.83.4.71:6001/tydic-xj-integration-backend/';
var HOST_PATH = 'yth.sdp.xjqyxxhb.com/tydic-xj-integration-backend/';

//    HOST_PATH = 'localhost:6001/tydic-xj-integration-backend/';
    geoserverUrl = ["http://135.224.181.135:6001/geoserver"];
    geoserverUrls = ["http://135.224.181.135:6001/geoserver/neto/wms"];
    gwcurls = "http://135.224.181.135:6001/geoserver/gwc/service/wms";


if (window.location.host === '10.60.57.11:6001') {
    mapAddress = {
        "vectorLayer": [
            "http://10.60.57.10:6002/webrd01/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webrd02/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webrd03/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webrd04/appmaptile?lang=zh_cn&size=1&scale=1&style=8&x={x}&y={y}&z={z}"],

        "imageLayer": [
            "http://10.60.57.10:6002/webst01/appmaptile?style=6&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webst02/appmaptile?style=6&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webst03/appmaptile?style=6&x={x}&y={y}&z={z}",
            "http://10.60.57.10:6002/webst04/appmaptile?style=6&x={x}&y={y}&z={z}"],
        "lwLayer": [
            "http://10.60.57.10:6002/webst01/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scale=1&style=8",
            "http://10.60.57.10:6002/webst02/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scale=1&style=8",
            "http://10.60.57.10:6002/webst03/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scale=1&style=8",
            "http://10.60.57.10:6002/webst04/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scale=1&style=8"]
    ...
    geoserverUrl = ["http://10.60.57.10:6002/geoserver"];
    geoserverUrls = ["http://10.60.57.10:6002/geoserver/neto/wms"];
    gwcurls = "http://10.60.57.10:6002/geoserver/gwc/service/wms";
    HOST_PATH = '10.60.57.11:6001/tydic-xj-integration-backend/';
}

if (window.location.host === '135.224.181.135:6001') {
    mapAddress = {
        "vectorLayer": [
        ...
        "lwLayer": [
            "http://135.224.181.90:6002/webst01/appmaptile?x={x}&y={y}&z={z}&lang=zh_cn&size=1&scale=1&style=8",
    ...
    geoserverUrls = ["http://135.224.181.135:6001/geoserver/neto/wms"];
    gwcurls = "http://135.224.181.135:6001/geoserver/gwc/service/wms";
    HOST_PATH = '135.224.181.135:6001/tydic-xj-integration-backend/';
}
if (window.location.host === '222.83.4.71:6001') {
    HOST_PATH = '222.83.4.71:6001/tydic-xj-integration-backend/';
}
