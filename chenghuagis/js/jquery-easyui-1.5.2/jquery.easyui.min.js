...
$.ajax({type:opts.method,url:opts.url,data:_1cc,dataType:"json",headers:opts.headers,success:function(data){
_1cd(data);
},error:function(){
...
$.ajax({type:opts.method,headers:opts.headers,url:opts.href,cache:false,data:_273,dataType:"html",success:function(data){
_274(data);
},error:function(){
...
var data={};
data[_4f0[1]]=_4ef;
var _4f1=$.ajax({url:_4f0[0],dataType:"json",headers:opts.headers,data:data,async:false,cache:false,type:"post"}).responseText;
return _4f1=="true";
...
$.ajax({url:data,data:_59b,headers:opts.headers,dataType:"json",success:function(data){
_59c(data);
},error:function(){
...
$.ajax({type:opts.method,headers:opts.headers,url:opts.url,data:_86e,dataType:"json",success:function(data){
_86f(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_9d8,dataType:"json",success:function(data){
_9d9(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_aa8,dataType:"json",success:function(data){
_aa9(data);
},error:function(){
