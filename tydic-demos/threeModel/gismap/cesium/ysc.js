...
(function (window,undefined) {
    var ysc={
        ...
        ,createLightScan_getCirclePoints:createLightScan_getCirclePoints
        ,createLightScan_entityCList:createLightScan_entityCList
    };
    /**
    ...
    */
    ...
    function getTransPoints(x1, y1, x2, y2, angle){
        ...
        return {x: (x2 + l*cosy), y: (y2 + l*siny)};
    }
